...
int arcColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end_, Uint32 color);
int arcRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end_,  Uint8 r, Uint8 g, Uint8 b, Uint8 a);
...
int pieColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,  Sint16 start, Sint16 end_, Uint32 color);
int pieRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,  Sint16 start, Sint16 end_, Uint8 r, Uint8 g, Uint8 b, Uint8 a);
int filledPieColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,  Sint16 start, Sint16 end_, Uint32 color);
int filledPieRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,  Sint16 start, Sint16 end_, Uint8 r, Uint8 g, Uint8 b, Uint8 a);
